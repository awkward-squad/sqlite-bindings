...
These functions are variants that explicitly involve an `Int64` in place of an `Int`, but 32-bit systems seem uncommon.
...
These functions encode text using UTF-16, which seems less convenient than UTF-8.
